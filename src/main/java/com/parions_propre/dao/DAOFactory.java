...
public class DAOFactory {
    ...
    private static final String FICHIER_PROPERTIES       = "/com/parions_propre/dao/dao.properties";
    ...
    public static DAOFactory getInstance() throws DAOConfigurationException {
        ...
        if ( fichierProperties == null ) {
            throw new DAOConfigurationException( "Le fichier properties " + FICHIER_PROPERTIES + " est null." );
        }
